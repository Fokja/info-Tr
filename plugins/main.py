...
START_TEXT = """**Hello {} 😌
I am a  translator telegram bot  based on Google api .**

>> `I can translate from any languages to any languages.`

Made with Love❤ by INFOTECH"""

HELP_TEXT = """**Hey, Sir🐓🐔  Follow these steps:**
...
👨‍💻 **Developer :** [Elphador](https://t.me/elphador_bot)

📢 ** Learning Channel :** [Spoken Class ](https://telegram.me/spoken99)

👥 **Discussion Group:** [Spoken Support](https://telegram.me/spoken9)

🌐 **Main Channel :** [👉 INFOTECH](https://t.me/infotechcomp)

📝 **Language used:** [Python3](https://python.org)

🧰 **Framework used :** [Pyrogram](https://pyrogram.org)

📡 **Server used :** [Heroku](https://heroku.com)"""

SETTINGS_TEXT = "Select your language for translating. Current default language is `{}`."

BUTTONS = [InlineKeyboardButton('⚙ Join Bot Channel for Updates ⚙', url='https://telegram.me/spoken99')]
